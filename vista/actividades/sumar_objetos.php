<?php
	...
	if(isset($_GET["Actividad"])){
		...
		if($actividad == "SUM THE OBJECTS"){
			$_SESSION["act11_consultar_imagenes"] = true;
			$_SESSION["act11_iteracion_prueba"] = 0;
		}	
	}
?>
<!DOCTYPE html>
...
<html>
	<head>
		...
		<script type="text/javascript" src="../../js/actividades/sumar_objetos.js"></script>
	...
	<body>
		<div class="cuerpo-actividad">
			...
			<div class="tv-plasma">
			<?php
				$descripcion = "Sum the objects on the board";
