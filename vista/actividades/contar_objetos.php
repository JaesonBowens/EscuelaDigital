<?php
	...
	if(isset($_GET["Actividad"])){
		...
		if($actividad == "CUENTA LOS OBJETOS"){
			$_SESSION["act5_consultar_imagenes"] = true;
			$_SESSION["act5_iteracion_prueba"] = 0;
		}	
	}
?>
<!DOCTYPE html>
<html>
	<head>
		...
		<script type="text/javascript" src="../../js/actividades/contar_objetos.js"></script>
		...
		<div class="cuerpo-actividad">
			<header class="cabecera">
				<section id="cabecera-izq">
					<span><b>COUNT THE OBJECTS</b></span>
				</section>
			...
			<div class="tv-plasma">
			<?php
				$descripcion = "Select the number of objects that are shown in the image";
