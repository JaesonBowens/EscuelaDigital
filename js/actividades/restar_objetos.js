...
$(document).ready(function(){
	...
	$("#informacion-texto").click(function(){
		detenerVideo("matematica/resta/resta.webm");
		detenerVideo("matematica/resta/lenguaje_signo/resta.webm");
	...
	$("#informacion-video").click(function(){
		cargarVideoFullScreen("matematica/resta/resta.webm");
	...
	$("#informacion-lenguaje-signo").click(function(){
		cargarVideo("matematica/resta/lenguaje_signo/resta.webm");
...
function cargarActividad(){
	...
	$.ajax({
		url: "../../controlador/actividades/restar_objetos.php",
		type: "POST",
		async: true,
		dataType: "json",
...
function mostrarActividad(data){
	...
	if(parseInt(numero1) > parseInt(numero2)){
		...
		resultado = parseInt(numero2) - parseInt(numero1);
		$("#img-cargar2").attr("src", imagen1);
		$("#img-cargar1").attr("src", imagen2);
	}
