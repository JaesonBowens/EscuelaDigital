...
(function (global, undefined) {
	...
	Alertify = function () {
		...
		dialogs = {
			...
			input   : "<input type=\"text\" class=\"alertify-text\" id=\"alertify-text\" style=\"text-align:center\">",
		...
		dialogs1 = {
			...
			input   : "<input type=\"password\" class=\"alertify-text\" id=\"alertify-text\" style=\"text-align:center\">",
			message : "<p class=\"alertify-message\">{{message}}</p>",
			log     : "<article class=\"alertify-log{{class}}\">{{message}}</article>"
		};
		...
		_alertify = {
			...
			build : function (item) {
				...
				if (type === "promptpassword") html += "<form id=\"alertify-form\">";

				html += "<article class=\"alertify-inner\">";
				html += dialogs.message.replace("{{message}}", message);

				if (type === "prompt") html += dialogs.input;
				if (type === "promptpassword") html += dialogs1.input;
				...
				if (type === "promptpassword") html += "</form>";
				...
				case "prompt":
					...
					break;
				case "promptpassword":
					html = html.replace("{{buttons}}", dialogs1.buttons.submit + dialogs1.buttons.cancel);
					html = html.replace("{{ok}}", this.labels.ok).replace("{{cancel}}", this.labels.cancel);
					break;
				case "alert":
					html = html.replace("{{buttons}}", dialogs.buttons.ok);
		...
		return {
			...
			confirmsuccess  : function (message, fn) { _alertify.dialog(message, "confirmsuccess", fn); return this; },
			extend          : _alertify.extend,
			init            : _alertify.init,
			log             : function (message, type, wait) { _alertify.log(message, type, wait); return this; },
			prompt          : function (message, fn, placeholder) { _alertify.dialog(message, "prompt", fn, placeholder); return this; },
			promptpassword  : function (message, fn, placeholder) { _alertify.dialog(message, "promptpassword", fn, placeholder); return this; },
