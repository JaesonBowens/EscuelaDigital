...
(function($){
            ...
            function () {
                ...
                if (!jQuery('#ptTimeSelectCntr').length) {
                    jQuery("body").append(
                        ...
                        +    '                    <div class="ptTimeSelectLeftPane" style="width: 45%; text-align: center; float: left;" class="">Hora</div>'
                        +    '                    <div class="ptTimeSelectRightPane" style="width: 45%; text-align: center; float: left;">Minutos</div>'
                        +    '                </div>'
                        +    '                <div>'
                        ...
                        +    '                filter:Alpha(Opacity=\'0\');width:2500px;height:2500px"></iframe>'
                        +    '        <![endif]-->'
                        +    '    </div></div>'
                    );
    ...
    jQuery.ptTimeSelect.setTime = function() {
	 ...
	 busquedaAvanzadaImagen( '', 'cuerpo-tabla-maestro', '../Controlador/ControladorGestionarImagen.php', 'consultaAvanzada');
        this.closeCntr();
