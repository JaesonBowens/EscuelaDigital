...
$(document).ready(function(){
	...
	$("#informacion-texto").click(function(){
		detenerVideo("matematica/contar_objetos/contar_objetos.webm");
		detenerVideo("matematica/contar_objetos/lenguaje_signo/contar_objetos.webm");
	...
	$("#informacion-video").click(function(){
		cargarVideoFullScreen("matematica/contar_objetos/contar_objetos.webm");
	...
	$("#informacion-lenguaje-signo").click(function(){
		cargarVideo("matematica/contar_objetos/lenguaje_signo/contar_objetos.webm");
...
function cargarActividad(){
	...
	$.ajax({
		url: "../../controlador/actividades/contar_objetos.php",
		type: "POST",
		async: true,
		dataType: "json",
