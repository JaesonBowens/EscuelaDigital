		...
		$(document).ready(function(){
			$("#id_ano_escolar").change(function(){
				...
				if(id_ano_escolar != ""){
					...
					$("#link_reporte").attr("href", "../controlador/reporte_docente.php?id_ano_escolar="+id_ano_escolar+"&&ano_escolar="+ano_escolar);
				}
				else{
...
<div id="contenido_principal">
	<section class="nombre_maestro">
		<h5>Report (List of Teachers)</h5>
	</section>

	<fieldset id="catalogo-maestro">
							<legend>Generate report of assigned teachers</legend>
										...
										<a id="link_reporte" href="#" target="reporte">
											<button type="button" id="reporte" name="reporte" title="Press to generate the report of the assigned teachers in the school year selected" class="boton" hidden="hidden"><img class='ico' src='../imagen/icono_boton/ib-13.png' alt='Icon'>  Generar</button>
											</a>
										</section>
										</section>
