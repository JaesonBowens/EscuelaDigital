...
<head>
	...
	<script language="javascript" type="text/javascript" src="../js/contenido.js"></script>

</head>

<body onLoad="busquedaAvanzada('', 'cuerpo-tabla-maestro', '../controlador/gestionar_contenido.php', 'consultaAvanzada')">
...
<div id="contenido_principal">
	...
	<fieldset id="catalogo-maestro">
							<legend>List of Contents</legend>
									<section class="form-izq">
										<section class="buscar-maestro-pequeno-label">
											<label for="buscar">Search:</label>
												<input list="lista" type="text" id="buscar" name="buscar" value="" size="13px" title="Enter content's name" maxlength="25" onKeypress="return validarLetra(event)" onKeyup="busquedaAvanzada(this.value, 'cuerpo-tabla-maestro', '../controlador/gestionar_contenido.php', 'consultaAvanzada'); validarLongitud(this.value, '25')" />
										</section>
									...
									<fieldset id="form-maestro-pequeno">
										<legend>Manage Content</legend>
											...
											<form action="../controlador/gestionar_contenido.php" method="POST">

											<section class="form-pequeno-cent">
												
												<section class="contenedor-label">
													<label for="nombre">Content:</label>
													<input type="hidden" id="id_contenido" name="id_contenido" />
													<input type="text" id="nombre_contenido" name="nombre_contenido" class="texto" value="" size="15px" placeholder="CONTENT'S NAME" pattern="[A-Za-z\s]*" maxlength="25" title="Enter name of content" onKeypress="return validarLetra(event)" />
												</section>
									...
									<section class="boton-maestro">
											...
											<button type="button" id="cancelar" name="cancelar" title="Press to cancel" class="boton" onClick="limpiarCamposcontenido(id = ['id_contenido', 'nombre_contenido'])"><img class='ico' src='../imagen/icono_boton/ib-2.png' alt='Icon'>  Cancel</button>
									</section>
